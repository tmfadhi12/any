          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="lahan-list">Lahan</a></li>
                <li class="nav-item"> <a class="nav-link" href="petani-list">Petani</a></li>
                <li class="nav-item"> <a class="nav-link" href="panen-list">Panen</a></li>
              </ul>
            </div>
          </li>
        </ul>
...
<?php /**PATH C:\Users\Fadhli\Documents\Kuliah\Semester 4\PKM DOSEN 1\bbpp2024\resources\views/template/index.blade.php ENDPATH**/ ?>